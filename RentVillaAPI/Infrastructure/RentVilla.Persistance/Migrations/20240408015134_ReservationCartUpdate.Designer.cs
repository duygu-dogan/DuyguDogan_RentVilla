...
namespace RentVilla.Persistence.Migrations
{
    ...
    [Migration("20240408015134_ReservationCartUpdate")]
    partial class ReservationCartUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentVilla.Domain.Entities.Concrete.Cart.ReservationCart", b =>
                {
                    b.HasOne("RentVilla.Domain.Entities.Concrete.Reservation", "Reservation")
                        .WithOne("ReservationCart")
                        .HasForeignKey("RentVilla.Domain.Entities.Concrete.Cart.ReservationCart", "ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
