...
namespace RentVilla.Persistence.Migrations
{
    ...
    [Migration("20240408015743_ReservationCartUpdate2")]
    partial class ReservationCartUpdate2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RentVilla.Domain.Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasOne("RentVilla.Domain.Entities.Concrete.Cart.ReservationCart", "ReservationCart")
                        .WithOne("Reservation")
                        .HasForeignKey("RentVilla.Domain.Entities.Concrete.Reservation", "ReservationCartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
